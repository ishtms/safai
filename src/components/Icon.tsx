...
export type IconName =
  ...
  | 'check' | 'x' | 'plus' | 'minus' | 'chevronL' | 'chevronR' | 'chevronD' | 'download'
  | 'warning' | 'info' | 'sparkle' | 'file' | 'folder' | 'image' | 'clock'
  | 'star' | 'eye' | 'lock' | 'globe' | 'refresh' | 'pause' | 'play'
  | 'menu' | 'heart' | 'moon' | 'sun' | 'arrowLeft';
...
// factories, not cached JSX. solid compiles JSX to real DOM nodes, so a shared
// reference would only render in the last mount point and "disappear" elsewhere.
